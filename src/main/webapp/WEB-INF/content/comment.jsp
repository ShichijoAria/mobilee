...
<div class="ui form pushable" method="post" action="view" id="main">
    ...
    <div class="pusher" style="height: 100%">
        <h2 class="ui header">
            <i class="talk outline alternate icon"></i>
            <div class="content">评论信息</div>
            <div class="sub header">Comment Information</div>
        </h2>
        <div  id="menu">
        ...
        <div class="ui loading segment"  id="segment">
            <table class="very selectable small celled large unstackable compact ui single line table">
                ...
                <tr class="center aligned">
                    ...
                    <th id="comment_id"/><i class="icon sort"></i>评论编号</th>
    ...
    <div class="image content">
        <form class="ui stackable  form three column grid" id="modal" style="width: 100%">
            ...
            <div class="row">
                <div class="field column">
                    <label>评论内容</label>
                    <textarea class="myTextarea" rows="3" readonly name="content"></textarea>
                </div>
            </div>
...
<script>
    ...
    function addInfoList(arr,data,module) {
        ...
        var html='';
        for(var i in list) {
            var head = "<tr id='" +list[i].comment_id+"' class='center aligned'>\n" +
                "    <td>\n" +
                "    <div class='ui checkbox'>\n" +
                "    <input type='checkbox' name='item' value='"+list[i].comment_id+"'><label></label>\n" +
                "    </div>\n" +
                "    </td>";
            var body="";
            for (var n in arr){
