...
<div class="ui form pushable" method="post" action="view" id="main">
    ...
    <div class="pusher" style="height: 100%">
        <h2 class="ui header">
            ...
            <div class="sub header">Collection Information</div>
        </h2>
        <div  id="menu">
        ...
        <div class="ui loading segment"  id="segment">
            <table class="very selectable small celled large unstackable compact ui single line table">
                ...
                <tr class="center aligned">
                    ...
                    <th id="collection_id"/><i class="icon sort"></i>收藏编号</th>
...
<div class="ui first modal">
    ...
    <div class="image content">
        <form class="ui stackable  form three column grid" id="modal" style="width: 100%">
            ...
            <div class="field column">
                <label>用户姓名</label>
                <input type="text" readonly name="user.name">
            </div>
            <div class="field column">
                <label>手机名称</label>
...
<script>
    ...
    function addInfoList(arr,data,module) {
        ...
        var html='';
        for(var i in list) {
            var head = "<tr id='" +list[i].collection_id+"' class='center aligned'>\n" +
                "    <td>\n" +
                "    <div class='ui checkbox'>\n" +
                "    <input type='checkbox' name='item' value='"+list[i].collection_id+"'><label></label>\n" +
                "    </div>\n" +
                "    </td>";
            var body="";
            for (var n in arr){
